        ...
        if (data['code'] === 0) {
            ...
            if (!data['list'] || data['list'].length === 0) {
                ...
                $.each(data['list'], function () {
                    ...
                    var link = $('<a class="am-list-item-hd am-text-truncate am-u-sm-12 am-u-md-6 am-padding-left-sm"></a>').attr('href', href).text(this.title);
                    var author = $('<span class="am-list-author am-text-truncate am-u-md-2 am-show-lg-up am-text-center"></span>').text(this.nickname);
                    var stat = $('<span class="am-list-stat am-text-truncate am-u-md-1 am-show-lg-up am-text-center"></span>').text(this.comment_count);
                    var time = $('<span class="am-list-date am-text-truncate am-u-md-3 am-show-lg-up am-text-center"></span>').text(CtsTimeFormat(this.updated_at));
